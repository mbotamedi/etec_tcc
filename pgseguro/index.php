        ...
        <div class="card shadow-sm">
            <div class="card-body p-4 p-md-5">
                <div class="text-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-shield-lock-fill text-primary" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.52 1.52 0 0 0-1.042.87C.637 3.18.5 4.22.5 5.333v5.133a6.2 6.2 0 0 0 1.518 4.223c.996.996 2.296 1.503 3.482 1.756C6.157 16.5 7.31 16.5 8 16.5s1.843 0 2.928-.321c1.11-.302 2.229-.655 2.887-.87a1.52 1.52 0 0 0 1.042-.87c.637-1.18.75-2.22.75-3.333V5.333c0-1.113-.137-2.153-.75-3.333a1.52 1.52 0 0 0-1.042-.87c-.658-.215-1.777-.57-2.887-.87C9.843.266 8.69 0 8 0m0 5a1.5 1.5 0 0 1 .5 2.915v.345a1.5 1.5 0 1 1-1 0v-.345A1.5 1.5 0 0 1 8 5"/></svg>
