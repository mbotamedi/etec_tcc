...
if (!$dados['id_cliente'] == null) {
    ...
    FROM tb_pedidos p  LEFT JOIN tb_cliente_endereco e ON p.id_endereco = e.id LEFT JOIN tb_cidades c ON e.id_cidade = c.codigo_cidade where tipo_pedido ='PDV' and p.id = '$id_pedido'";
}
        ...
        <div class="col-md-4">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <span class="badge bg-warning text-dark"></strong> <?= ucfirst($pedido['status_pagamento']) ?></span>
                </li>
            </ul>
        </div>
