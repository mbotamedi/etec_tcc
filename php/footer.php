    ...
    <footer class="py-5 bg-dark">
        <div class="info-footer">
            <div class="information-divs">
                ...
                <ul class="ul-content">
                    <li>
                        <a href="unidades.php">Nossa história</a>
                    </li>
                    <li>
            ...
            <div class="information-divs">
                ...
                <ul class="ul-content">
                    <li>
                        <a href="compra_segura.php">É seguro comprar?</a>
                    </li>
                    <li>
                        <a href="info_pedidos.php">Como funciona os Pedidos</a>
                    </li>
                    <li>
        ...
        <footer class="py-5 bg-dark">
            <div class="info-footer">
                <div class="information-divs">
                    ...
                    <ul class="ul-content">
                        <li>
                            <a href="../../php/unidades.php">Nossa história</a>
                        </li>
                        <li>
                            <a href="../../php/termos_Uso.php">Termos de uso</a>
                        </li>
                    </ul>
                </div>
                <div class="information-divs">
                    ...
                    <ul class="ul-content">
                        <li>
                            <a href="../../php/compra_segura.php">É seguro comprar?</a>
                        </li>
                        <li>
                            <a href="../../php/info_pedidos.php">Como funciona os Pedidos</a>
                        </li>
                        <li>
                            <a href="../../php/reembolso.php">Política de Reembolso</a>
                        </li>
                    </ul>
                </div>
                <div class="information-divs">
